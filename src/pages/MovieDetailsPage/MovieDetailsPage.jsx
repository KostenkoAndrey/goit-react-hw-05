    ...
    <Link to={goBack.current} className={s.goBackBtn}>&#x2190; Go Back</Link>
     <div className={s.detailsCont}>
      <div className={s.innerPictCont}>
        <img src={ backdrop_path ? `https://image.tmdb.org/t/p/w500${backdrop_path}` : "https://www.reelviews.net/resources/img/default_poster.jpg"} alt={original_title} height={420}/>
        </div>
        <div className={s.innerDetailCont}>
            <h3 className={s.title}>{original_title}</h3>
            <p className={s.description}>User Score: {vote_average}</p>
